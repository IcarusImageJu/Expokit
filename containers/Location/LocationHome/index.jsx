...
function LocationHome({ locations, buttons, handleLoadButtons }) {
	...
	async function imageSize() {
		...
		Image.getSizeWithHeaders(
			`${API()}/action/getSecureFiles?id=${currentLocation.field20}`,
	...
	return (
		<ScrollView contentContainerStyle={styles.scrollInner}>
			<View style={styles.container}>
				...
				<AnimParent pose="enter" initialPose="exit" style={styles.boxInfos}>
					{haveContacts && (
						<AnimItem style={styles.boxInfo}>
							<BoxInfosControl
					...
					{haveOverview && (
						<AnimItem initialPose="exit" pose="enter" style={styles.boxInfo}>
							<BoxInfosControl
